...
event_info.post("/detail", async (ctx) => {
  ...
  let classify = ruleForm.classify[0];
  ...
  await new Promise((resolve, reject) => {
    ...
    return new Promise((resolve, reject) => {
      let sql = `insert into event_info values('${ruleForm.title}','${classify}','${uuid}','${ruleForm.time}','${ruleForm.properties}','${ruleForm.level}','${ruleForm.position}','${ruleForm.street}','${ruleForm.describe}','${ruleForm.community}','${ruleForm.name}','${ruleForm.sex}','${ruleForm.phone}','${ImageListString}','${ruleForm.state}');`;
      ...
      return new Promise((resolve, reject) => {
        let sql2 = `insert into event_search values('${uuid}','${ruleForm.name}','${ruleForm.street}','${classify}','${ruleForm.time}','${ruleForm.state}');`;
